...
export async function generateMetadata(): Promise<Metadata> {
  ...
  let siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'SONETV';
...
export default async function RootLayout({
  ...
  return (
    <html lang='zh-CN' suppressHydrationWarning>
      ...
      <body
        className={`${inter.className} min-h-screen bg-gray-50/50 text-gray-900 dark:bg-black dark:text-gray-200`}
      >
        <LiquidBackground />
        <ThemeProvider
          attribute='class'
