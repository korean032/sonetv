...
interface HomeState {
  activeTab: 'home' | 'favorites' | 'continuewatching';
...
type HomeAction =
  | {
      type: 'SET_ACTIVE_TAB';
      payload: 'home' | 'favorites' | 'continuewatching';
    }
    ...
    fetch('/api/release-calendar?limit=100')
      ...
      .then((upcomingData) => {
        if (upcomingData?.items) {
          let releases = upcomingData.items;

          // 🚨 如果API返回空数据，使用本地fallback
          if (!releases || releases.length === 0) {
            console.warn('⚠️ API返回空数据，使用客户端fallback...');
            ...
            releases = [
              {
                ...
                cover:
                  'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2902678859.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_2',
                title: '末日逃生2：迁移',
                type: 'movie',
                director: '里克·罗曼·沃夫',
                actors: '杰拉德·巴特勒 / 莫瑞娜·巴卡琳',
                region: '美国',
                genre: '动作 / 惊悚',
                releaseDate: futureDate(1),
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2897466545.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_3',
                title: '没问题',
                type: 'movie',
                director: '蒋佳辰',
                actors: '梁龙 / 范丞丞',
                region: '中国大陆',
                genre: '喜剧',
                releaseDate: futureDate(2),
                cover:
                  'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2901847118.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_4',
                title: '年少有为',
                type: 'movie',
                director: '刘江',
                actors: '胡歌 / 张艺兴',
                ...
                releaseDate: futureDate(2),
                cover:
                  'https://img2.doubanio.com/view/photo/s_ratio_poster/public/p2887640822.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_5',
                title: '六六大顺',
                type: 'movie',
                director: '未知',
                actors: '未知',
                ...
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2882283085.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_6',
                title: '鹿鼎记2',
                type: 'movie',
                director: '王晶',
                actors: '周星驰',
                ...
                releaseDate: futureDate(3),
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2883398185.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_7',
                title: '河狸变身计划',
                type: 'movie',
                director: 'Dan Scanlon',
                actors: 'Bobby Moynihan',
                region: '美国',
                genre: '动画 / 喜剧',
                releaseDate: futureDate(22),
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2903218939.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_8',
                title: '风过留痕',
                type: 'movie',
                director: '张艺谋',
                actors: '雷佳音 / 于和伟',
                region: '中国大陆',
                genre: '犯罪 / 悬疑',
                releaseDate: futureDate(27),
                cover:
                  'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2873289949.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_9',
                title: '洛杉矶劫案',
                type: 'movie',
                director: '克里斯蒂安·古德加斯特',
                actors: '杰拉德·巴特勒',
                region: '美国',
                genre: '动作 / 犯罪',
                releaseDate: futureDate(32),
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2893537878.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_10',
                title: '呼啸山庄',
                type: 'movie',
                director: '埃默拉尔德·芬内尔',
                actors: '玛格特·罗比',
                ...
                releaseDate: futureDate(32),
                cover:
                  'https://img9.doubanio.com/view/photo/s_ratio_poster/public/p2900829805.jpg',
                source: 'mock',
              },
              {
                id: 'client_fallback_tv_1',
                title: '三体 第二季',
                type: 'tv',
                director: '杨磊',
                actors: '张鲁一 / 于和伟',
          ...
          if (workerRef.current) {
            ...
            console.warn('📅 Web Worker不可用，直接使用原始数据');
            dispatch({
              type: 'SET_UPCOMING_RELEASES',
              payload: releases.slice(0, 12),
            });
  ...
  return (
    <PageLayout>
      ...
      <div className='overflow-visible -mt-6 md:mt-0 pb-32 md:pb-safe-bottom'>
        {/* 顶部 Header 区域：问候语 + 切换开关 - 极致简约设计 */}
        <div className='relative flex flex-col md:flex-row items-center justify-between gap-4 mb-8 pt-2 md:pt-4'>
          {/* 左侧：问候语 - 更加通透的排版 */}
          <div className='text-center md:text-left'>
            <h1 className='text-2xl md:text-3xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-gray-900 via-purple-800 to-gray-900 dark:from-white dark:via-purple-200 dark:to-white drop-shadow-sm'>
              {greeting}
              {username && `，${username}`}{' '}
          ...
          <div className='hidden md:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none'>
            <div className='flex items-center gap-2'>
              <span className='text-4xl font-black italic tracking-tighter bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 drop-shadow-lg select-none pr-2 pb-1'>
                SONETV
              </span>
            </div>
          </div>
          ...
          <div className='shrink-0'>
            <CapsuleSwitch
              options={[
                { label: '首页', value: 'home' },
                { label: '继续观看', value: 'continuewatching' },
              ...
              onChange={(value) =>
                dispatch({
                  type: 'SET_ACTIVE_TAB',
                  payload: value as 'home' | 'favorites' | 'continuewatching',
                })
              }
            />
          </div>
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 border ${
                          upcomingFilter === key
                            ? 'bg-orange-500/90 backdrop-blur-md text-white shadow-lg shadow-orange-500/30 border-orange-500/50'
                            : 'bg-gray-100/50 dark:bg-gray-800/40 backdrop-blur-md text-gray-700 dark:text-gray-300 border-white/20 dark:border-white/5 hover:bg-white/30 dark:hover:bg-white/10'
                        }`}
                      >
                        {label}
                        {count > 0 && (
