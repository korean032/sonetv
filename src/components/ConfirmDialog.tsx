...
export function ConfirmDialog({
  ...
  const dialogContent = (
    <div className='fixed inset-0 z-[9999] flex items-center justify-center p-4 animate-fade-in'>
      ...
      {/* 对话框 */}
      <div className='relative w-full max-w-md bg-white/90 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700 animate-slide-up'>
        {/* 关闭按钮 */}
        <button
          onClick={onCancel}
