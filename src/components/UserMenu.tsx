...
export const UserMenu: React.FC = () => {
  ...
  const menuPanel = (
    <>
      ...
      {/* 菜单面板 */}
      <div className='fixed top-14 right-4 w-56 bg-white/90 dark:bg-gray-900/80 backdrop-blur-md rounded-lg shadow-xl z-1001 border border-white/20 dark:border-gray-700 overflow-hidden select-none'>
        {/* 用户信息区域 */}
  ...
  const settingsPanel = (
    <>
      ...
      {/* 设置面板 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl max-h-[90vh] bg-white/90 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-gray-700 rounded-xl shadow-xl z-1001 flex flex-col'>
        {/* 内容容器 - 独立的滚动区域 */}
        <div
  ...
  const changePasswordPanel = (
    <>
      ...
      {/* 修改密码面板 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white/90 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-gray-700 rounded-xl shadow-xl z-1001 overflow-hidden'>
        {/* 内容容器 - 独立的滚动区域 */}
        <div
  ...
  const watchingUpdatesPanel = (
    <>
      ...
      {/* 更新弹窗 */}
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl max-h-[90vh] bg-white/90 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-gray-700 rounded-xl shadow-xl z-1001 flex flex-col'>
        {/* 内容容器 - 独立的滚动区域 */}
        <div
          className='flex-1 p-6 overflow-y-auto'
          data-panel-content
  ...
  const continueWatchingPanel = (
    <>
      ...
      {/* 继续观看弹窗 */}
      <div
        className='fixed inset-x-4 top-1/2 transform -translate-y-1/2 max-w-4xl mx-auto bg-white/90 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-gray-700 rounded-xl shadow-2xl z-1001 max-h-[80vh] overflow-y-auto'
