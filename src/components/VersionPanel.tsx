...
export const VersionPanel: React.FC<VersionPanelProps> = ({
  ...
  const versionPanelContent = (
    <>
      ...
      {/* 版本面板 */}
      <div
        className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl max-h-[90vh] bg-white/90 dark:bg-gray-900/80 backdrop-blur-md border border-white/20 dark:border-gray-700 rounded-xl shadow-xl z-1001 overflow-hidden'
        onTouchMove={(e) => {
