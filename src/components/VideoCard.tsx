...
const VideoCard = forwardRef<VideoCardHandle, VideoCardProps>(
  function VideoCard(
    ...
    const hasBottomTags = useMemo(() => {
      return (
        (remarks && (isSeriesCompleted(remarks) || hasReleaseTag)) ||
    ...
    return (
      <>
        <div
          className='@container group relative w-full rounded-lg bg-gray-50/50 dark:bg-gray-900/40 backdrop-blur-md border border-white/20 dark:border-white/5 cursor-pointer transition-all duration-300 ease-in-out hover:scale-[1.05] hover:z-30 hover:shadow-2xl hover:bg-gray-100/60 dark:hover:bg-gray-800/50'
          onClick={handleClick}
          {...longPressProps}
          style={
            {
